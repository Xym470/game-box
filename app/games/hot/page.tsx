...
export const metadata: Metadata = {
  title: `热门游戏 | ${SITE_NAME}`,
  description: `浏览所有热门H5游戏，在线畅玩。`,
  keywords: ["热门游戏", "H5游戏", "在线游戏", SITE_NAME],
}

export default async function HotGamesPage() {
  const gamesData = await getGames("popular", undefined, 48) // 获取热门游戏

  const breadcrumbItems = [{ name: "首页", href: "/" }, { name: "热门游戏" }]
